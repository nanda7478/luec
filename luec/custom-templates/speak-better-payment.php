...
<?php if(isset($_GET['session_package'])){ ?>
...
<?php
if ($_GET['type'] == 'old') {
 	$product_list = get_field('sessions_purchase', pll_current_language('slug'));
 }else{
 	$product_list = get_field('sessions_purchase', 'option');
 }

$id = intval($_GET['session_package']);
	...
	<div class="row" >
		...
		<div class="row">
			<div class="col-12 form-group">
				...
				<input type="hidden" name="package[type]" value="session_package">
